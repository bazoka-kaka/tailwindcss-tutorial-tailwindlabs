...
## Adding common margin to all children components

add this to your parent component class:<br>
<code>space-y-\[height\]</code>
<br>
This is gonna add margin to all your children components except for the first one.

## Start Coding

in index.jsx (we're using nextjs)
